...
namespace SmartCodingHub.Collections
{
    ///------------------------------------------------------------------------------------------------------
    /// <summary> -----------------------------------------------------------------
    ///             Namespace:      Cartif.Util Class:          CollectionComparer Description:
    ///             Represents a service used to compare two collections for equality. Author:
    ///             Oscar - Cartif       Date: 14-09-2015 Notes: Revision History: Name:           Date:
    ///             Description:
    ///           -----------------------------------------------------------------. </summary>
    ...
    public class CollectionComparer<T>
    {
        ...
        ///--------------------------------------------------------------------------------------------------
        /// <summary> Compares two object instances represent the same object. </summary>
        /// <remarks> Oscvic, 2016-01-18. </remarks>
        ...
        /// </summary>
        private SamenessComparer samenessComparer;  /* The sameness comparer */
        ...
        ///--------------------------------------------------------------------------------------------------
        /// <summary> Creates a new instance of a collection comparer that compares two collections for
        ///           equality. </summary>
        /// <remarks> Oscvic, 2016-01-18. </remarks>
        ///--------------------------------------------------------------------------------------------------
        ...
        ///--------------------------------------------------------------------------------------------------
        /// <summary> Creates a new instance of a collection comparer with the specified comparer. </summary>
        /// <remarks> Oscvic, 2016-01-18. </remarks>
        ...
        ///--------------------------------------------------------------------------------------------------
        /// <summary> Compares the content of two collections for equality. </summary>
        /// <remarks> Oscvic, 2016-01-18. </remarks>
