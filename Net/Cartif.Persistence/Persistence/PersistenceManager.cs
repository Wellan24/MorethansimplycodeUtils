...
namespace Persistence
{
    ...
    public class PersistenceManager
    {
        ...
        public static int Insert(PersistenceData data, NpgsqlConnection connection = null, Boolean isAutonumeric = true) { return InnerInsert(data, useIdColumn: !isAutonumeric, connection: connection); }

        public static int Insert(PersistenceData data, NpgsqlConnection connection = null, params String[] columnsToInsert) { return InnerInsert(data, columnsToInsert, true, connection); }
