...
namespace LAE.Comun.Documentacion
{
    public class CeldaTabla
    {
        ...
        public CeldaTabla WidthCell(int size)
        {
        ...
        public CeldaTabla Border(int left, int top, int right, int bottom)
        {
            LeftBorder(left);
            TopBorder(top);
            RightBorder(right);
        ...
        public CeldaTabla Border(int value)
        {
        ...
        public CeldaTabla Font(String font)
        {
        ...
        {
            return Celda(texto).VerticalAlignment(TableVerticalAlignmentValues.Center).Font("Frutiger LT Std 45 Light");
        }
    }
}
