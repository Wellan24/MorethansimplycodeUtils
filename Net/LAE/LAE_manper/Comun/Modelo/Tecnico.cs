...
namespace LAE.Comun.Modelo
{
    public class FactoriaTecnicos
    {
        ...
        //private static TipoTecnico[] tipos = null;
        //public static Tecnico[] GetTecnicosBiomasa()
        //{
        //    if (tipos == null)
        //        tipos = PersistenceManager.SelectAll<TipoTecnico>().ToArray();
        //    var a=from tipo in tipos
