...
namespace LAE.Comun.Persistence
{
    ...
    public class PersistenceData : IFormattable
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            ColumnPropertiesInfo idColumn = PersistentAttributesUtil.GetIdColumn(tipo);
        ...
        public override int GetHashCode()
        {
            ...
            PropertyInfo propiedadId = this.GetType().GetProperty(idColumn.PropertyName, BindingFlags.Public | BindingFlags.Instance);
