    ...
    public partial class ControlCenizas : UserControl, IMedicion
    {
                ...
                new TypePanelSettings<ReplicaCeniza>
                {
                    ...
                    Fields = new FieldSettings
                    {
                        ...
                        ["IdUdsM3"] = PropertyControlSettingsEnum.ComboBoxDefault
                            ...
                            .SetLabel("")
                            .SetEnabled(false),
                        ["Cenizas2"] = PropertyControlSettingsEnum.TextBoxEmptyToNullReadOnly
                            .SetLabel("Cenizas(%)")
                            .AddTextChanged((s, e) => { }),
                    },
                    IsUpdating = true,
        ...
        private void RealizarCalculo()
        {
            ...
            else
            {
                ...
                double totalHU3 = PersistenceManager.SelectByID<Humedad3>(Cenizas.IdHumedad3).MediaHumedadTotalCalculado ?? 0;
                double? totalHUM = (Cenizas.IdHumedad == null) ? null : PersistenceManager.SelectByID<HumedadTotal>(Cenizas.IdHumedad)?.MediaHumedadTotalCalculado;

                Cenizas.MediaCenizasHU3 = Calcular.Promedio(valoresCenizas).Value;
                Cenizas.MediaCenizasSeca = Cenizas.MediaCenizasHU3 * (100.0 / (100.0 - totalHU3));
                Cenizas.MediaCenizasHUM = (totalHUM == null) ? null : Cenizas.MediaCenizasSeca * ((100.0 - totalHUM) / 100.0);
                ...
                ResultadoInforme resultado = Calcular.Resultado(Cenizas.MediaCenizasHU3 ?? 0, Cenizas.IdVProcedimiento, Cenizas.IdParametro, 1, 1);
