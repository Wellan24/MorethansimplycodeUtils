...
namespace Persistence
{
    ...
    public class PersistenceDataBase
    {
        ...
        public static readonly string STRING_CONNECTION =
            ...
            ? "Server=thot-test;Port=5432;Database=LAE;UserId=postgres;Password=bBdD_pg91%SqL;Pooling=true;MinPoolSize=5;MaxPoolSize=10;"
            : "Server=thot;Port=5432;Database=LAE;UserId=gestion;Password=f0e13dca45;Pooling=true;MinPoolSize=5;MaxPoolSize=10;";    /* . */
