...
namespace Cartif.Extensions
{
    ...
    public static class ArrayExtensions
    {
        ...
        ///--------------------------------------------------------------------------------------------------
        /// <summary> A T[] extension method that inserts other array. Inserts at the end. Can throw an exception if the
        ///           index is not valid (> int.Max). </summary>
        /// <remarks> Manper, 2016-04-14. </remarks>
        /// <typeparam name="T"> Generic type parameter. </typeparam>
        /// <param name="array"> The array to act on. </param>
        /// <param name="arrayAdd">   The array to add. </param>
        /// <returns> A T[]. </returns>
        ///--------------------------------------------------------------------------------------------------
        public static T[] Insert<T>(this T[] array, T[] arrayAdd)
        {
            int size = array.Length;
            Array.Resize(ref array, array.Length + arrayAdd.Length);
            for (int i = 0; i < arrayAdd.Length; i++)
            {
                array[size + i] = arrayAdd[i];
            }
            return array;
        }
