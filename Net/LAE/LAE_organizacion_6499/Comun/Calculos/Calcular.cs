...
namespace LAE.Comun.Calculos
{
    public class Calcular
    {
        ...
        public static Valor PromedioSecado(ValorHumedad[] valoresPorcentaje, Func<double?, double?, double?> funcPorcentajeSeca)
        {
            if (valoresPorcentaje != null && valoresPorcentaje.Count() > 0)
            {
                double? valor = valoresPorcentaje.Average(v => funcPorcentajeSeca(v.Valor.Value, v.Humedad));
