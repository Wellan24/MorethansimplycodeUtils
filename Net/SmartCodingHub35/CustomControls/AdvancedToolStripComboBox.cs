...
{
    ///------------------------------------------------------------------------------------------------------
    /// <summary> An advanced tool strip combo box. </summary>
    /// <remarks> Oscvic, 2016-01-18. </remarks>
    ///------------------------------------------------------------------------------------------------------
    class AdvancedToolStripComboBox : ToolStripComboBox
    {
        ///--------------------------------------------------------------------------------------------------
        ...
        /// <remarks> Oscvic, 2016-01-18. </remarks>
        ///--------------------------------------------------------------------------------------------------
        public AdvancedToolStripComboBox()
        {
            this.ComboBox.DrawMode = DrawMode.OwnerDrawFixed;
            this.HighlightColor = ColorTranslator.FromHtml("#8CC63E");
            this.ComboBox.DrawItem += new DrawItemEventHandler(ComboBoxPersonalizado_DrawItem);
        }
