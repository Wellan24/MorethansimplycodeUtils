...
namespace Cartif.Extensions
{
    ...
    public static class LinqExtensions
    {
        ...
        ///--------------------------------------------------------------------------------------------------
        public static List<TReturn> Collect<TOrigin, TReturn>(
        ...
        /// <returns> A List&lt;TReturn&gt; </returns>
        ///--------------------------------------------------------------------------------------------------
        public static List<TReturn> Map<TOrigin, TReturn>(
           this IEnumerable<TOrigin> enumeration, Func<TOrigin, TReturn> func)
        {
            var result = new List<TReturn>();

            enumeration.ForEach(element => result.Add(func.Invoke(element)));
